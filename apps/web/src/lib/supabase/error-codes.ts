...
export const SUPABASE_AUTH_ERROR_MESSAGES = {
    ...
    EMAIL_ADDRESS_INVALID:
        "Please enter a valid email address. Test domains are not supported.",
    WEAK_PASSWORD:
    ...
    EMAIL_PROVIDER_DISABLED:
        "Email signup is currently disabled. Please contact support.",
    ...
    USER_NOT_FOUND:
        "No account found with this email address. Please sign up instead.",
    USER_BANNED:
...
export const SIGNUP_ERROR_MAP = new Map<string, string>([
    [
        SUPABASE_AUTH_ERRORS.EMAIL_ADDRESS_INVALID,
        SUPABASE_AUTH_ERROR_MESSAGES.EMAIL_ADDRESS_INVALID,
    ],
    [
        SUPABASE_AUTH_ERRORS.WEAK_PASSWORD,
        SUPABASE_AUTH_ERROR_MESSAGES.WEAK_PASSWORD,
    ],
    [
        SUPABASE_AUTH_ERRORS.SIGNUP_DISABLED,
        SUPABASE_AUTH_ERROR_MESSAGES.SIGNUP_DISABLED,
    ],
    [
    ...
    [
        SUPABASE_AUTH_ERRORS.VALIDATION_FAILED,
        SUPABASE_AUTH_ERROR_MESSAGES.VALIDATION_FAILED,
    ],
    [
        SUPABASE_AUTH_ERRORS.PASSWORD_TOO_SHORT,
        SUPABASE_AUTH_ERROR_MESSAGES.PASSWORD_TOO_SHORT,
    ],
    [
        SUPABASE_AUTH_ERRORS.PASSWORD_TOO_WEAK,
        SUPABASE_AUTH_ERROR_MESSAGES.PASSWORD_TOO_WEAK,
    ],
    [
        SUPABASE_AUTH_ERRORS.EMAIL_INVALID_FORMAT,
        SUPABASE_AUTH_ERROR_MESSAGES.EMAIL_INVALID_FORMAT,
    ],
    [
    ...
    [
        SUPABASE_AUTH_ERRORS.MISSING_FIELDS,
        SUPABASE_AUTH_ERROR_MESSAGES.MISSING_FIELDS,
    ],
    [
        SUPABASE_AUTH_ERRORS.UNEXPECTED_FAILURE,
...
export const LOGIN_ERROR_MAP = new Map<string, string>([
    [
        SUPABASE_AUTH_ERRORS.INVALID_CREDENTIALS,
        SUPABASE_AUTH_ERROR_MESSAGES.INVALID_CREDENTIALS,
    ],
    [
        SUPABASE_AUTH_ERRORS.EMAIL_NOT_CONFIRMED,
        SUPABASE_AUTH_ERROR_MESSAGES.EMAIL_NOT_CONFIRMED,
    ],
    [
        SUPABASE_AUTH_ERRORS.USER_NOT_FOUND,
        SUPABASE_AUTH_ERROR_MESSAGES.USER_NOT_FOUND,
    ],
    [
        SUPABASE_AUTH_ERRORS.USER_BANNED,
        SUPABASE_AUTH_ERROR_MESSAGES.USER_BANNED,
    ],
    [
...
export function normalizeSupabaseError(errorMessage: string): string {
    ...
    if (lowerMessage.includes("email_address_invalid") || 
    ...
    if (lowerMessage.includes("validation_failed") || 
...
export function getErrorMessage(errorCode: string): string {
    return SIGNUP_ERROR_MAP.get(errorCode) ||
