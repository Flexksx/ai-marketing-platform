...
from vozai.domain.content_generation_job.generation.shared.service import (
    BaseContentGenerationJobRunner,
)
from vozai.domain.content_generation_job.generation.text_with_single_image.service import (
