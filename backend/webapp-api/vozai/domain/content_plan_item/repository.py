...
from vozai.domain.content_plan_item.entity import ContentPlanItemRecord
from vozai.domain.content_plan_item.errors import ContentPlanItemNotFoundException
