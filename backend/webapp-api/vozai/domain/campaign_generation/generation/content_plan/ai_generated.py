...
from vozai.domain.campaign_generation.generation.content_plan.model import (
    AgentGeneratedPostingPlanResult,
)
from vozai.domain.campaign_generation.generation.errors import (
...
class AIGeneratedContentPlanGenerator:
    ...
    async def generate(
        ...
        try:
            ...
            return await self.merge_to_campaign_generation_job_result(job, content_plan)
