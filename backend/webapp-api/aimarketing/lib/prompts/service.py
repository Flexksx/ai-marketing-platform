...
from aimarketing.domain.brand_archetype.model import (
    BrandArchetype,
    BrandArchetypeData,
    BrandArchetypeName,
)
...
class PromptService:
    ...
    def _create_environment(self) -> Environment:
        ...
        env.globals["tone_library"] = self._transform_tone_library_for_template()
        env.globals["archetype_library"] = (
            self._transform_archetype_library_for_template()
        )
        env.globals["content_type_library"] = (
    ...
    def _load_content_type_library(self) -> dict[ContentTypeName, dict[str, str]]:
        ...
        result: dict[ContentTypeName, dict[str, str]] = {}
        ...
        for section_name, values in data.items():
            ...
            try:
                content_type = ContentTypeName[section_name]
            except KeyError as e:
                raise PromptConfigError(
            ...
            result[content_type] = {"description": description}
