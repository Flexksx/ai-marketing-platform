...
from aimarketing.domain.brand_extraction.entity import BrandGenerationJobRecord
from aimarketing.domain.brand_extraction.errors import BrandGenerationJobNotFoundError
